...
export const CATALOG: CatalogItem[] = [
  ...
  mk({ id: "art_rock_mono_jacks", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 5500, currency: "EUR",
    name: { en: "The Mono Jacks", ro: "The Mono Jacks" }, description: { en: "Indie rock · live band. + VAT.", ro: "Indie rock · trupă live. + TVA." } }),
  mk({ id: "art_rock_partizan", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 3500, currency: "EUR",
    name: { en: "Partizan", ro: "Partizan" }, description: { en: "Rock · live band. + VAT.", ro: "Rock · trupă live. + TVA." } }),
  mk({ id: "art_rock_dora", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 3000, currency: "EUR",
    name: { en: "Dora Gaitanovici", ro: "Dora Gaitanovici" }, description: { en: "Indie folk · live act. + VAT.", ro: "Indie folk · moment live. + TVA." } }),
  mk({ id: "art_rock_kumm", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 2300, currency: "EUR",
    name: { en: "Kumm", ro: "Kumm" }, description: { en: "Rock · live band. + VAT.", ro: "Rock · trupă live. + TVA." } }),
  // DJ
  mk({ id: "art_dj_sickotoy", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 3500, currency: "EUR",
    name: { en: "Sickotoy", ro: "Sickotoy" }, description: { en: "DJ · headliner set. + VAT.", ro: "DJ · set cap de afiș. + TVA." } }),
  mk({ id: "art_dj_manuel_riva", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 2500, currency: "EUR",
    name: { en: "Manuel Riva", ro: "Manuel Riva" }, description: { en: "DJ · live set. + VAT.", ro: "DJ · set live. + TVA." } }),
  mk({ id: "art_dj_sasha_lopez", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 2000, currency: "EUR",
    name: { en: "Sasha Lopez", ro: "Sasha Lopez" }, description: { en: "DJ · live set. + VAT.", ro: "DJ · set live. + TVA." } }),
  mk({ id: "art_dj_cristi_stanciu", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 800, currency: "EUR",
  ...
  mk({ id: "sga_sushi_bar", category: "bar", eventTypes: [U, H, W], unit: "flat", price: 3500,
  ...
  mk({ id: "sga_limo", category: "transport", eventTypes: [U, H, W], unit: "flat", price: 1800,
  ...
  mk({ id: "wed_menu", category: "catering", eventTypes: [W], unit: "per_guest", price: 450, popular: true,
    name: { en: "Wedding Menu", ro: "Meniu Nuntă" }, description: { en: "Plated dinner with drinks, per guest.", ro: "Meniu servit cu băuturi, per invitat." } }),
  mk({ id: "wed_photo", category: "photography", eventTypes: [W], unit: "flat", price: 6000, popular: true,
    name: { en: "Photo & Video Team", ro: "Echipă Foto & Video" }, description: { en: "Full-day photo + cinematic video.", ro: "Foto + video cinematic toată ziua." } }),
  mk({ id: "wed_music", category: "music", eventTypes: [W], unit: "flat", price: 4500,
    name: { en: "DJ & Sound", ro: "DJ & Sonorizare" }, description: { en: "DJ with pro sound & lights.", ro: "DJ cu sonorizare & lumini." } }),
  mk({ id: "wed_decor", category: "decorations", eventTypes: [W], unit: "flat", price: 5000,
    name: { en: "Florals & Décor", ro: "Flori & Decor" }, description: { en: "Ceremony + reception florals and décor.", ro: "Flori și decor pentru ceremonie și petrecere." } }),
  mk({ id: "wed_cake", category: "cakes", eventTypes: [W], unit: "flat", price: 1200,
    name: { en: "Wedding Cake", ro: "Tort de Nuntă" }, description: { en: "Multi-tier personalized cake.", ro: "Tort personalizat pe mai multe etaje." } }),
  ...
  mk({ id: "candy_bar", category: "cakes", eventTypes: [U, H, W], unit: "flat", price: 1500,
    name: { en: "Candy Bar", ro: "Candy Bar" }, description: { en: "Sweet table with assorted treats.", ro: "Masă cu dulciuri asortate." } }),
  mk({ id: "prosecco_bar", category: "bar", eventTypes: [U, H, W], unit: "flat", price: 1800,
