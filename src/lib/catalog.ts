...
export const CATALOG: CatalogItem[] = [
  ...
  // ===== ARTISTS (one live act; price incl. travel/per diem, + VAT) =====
  mk({ id: "art_cristi_stanciu", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 4000,
    name: { en: "Cristi Stanciu (DJ)", ro: "Cristi Stanciu (DJ)" }, description: { en: "Resident DJ set. + VAT.", ro: "Set DJ. + TVA." } }),
  mk({ id: "art_maya_mar", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 4970,
    name: { en: "Maya Mar", ro: "Maya Mar" }, description: { en: "Live act. + VAT.", ro: "Moment live. + TVA." } }),
  mk({ id: "art_dara", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 14910,
    name: { en: "DARA", ro: "DARA" }, description: { en: "Live concert moment. + VAT.", ro: "Moment de concert live. + TVA." } }),
  mk({ id: "art_florian_rus", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 17400,
    name: { en: "Florian Rus", ro: "Florian Rus" }, description: { en: "Live concert moment. + VAT.", ro: "Moment de concert live. + TVA." } }),
  mk({ id: "art_holy_molly", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 19880,
    name: { en: "Holy Molly", ro: "Holy Molly" }, description: { en: "Live concert moment. + VAT.", ro: "Moment de concert live. + TVA." } }),
  mk({ id: "art_nicole_cherry", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 37280,
    name: { en: "Nicole Cherry", ro: "Nicole Cherry" }, description: { en: "Top national artist. + VAT.", ro: "Artist național de top. + TVA." } }),
  mk({ id: "art_antonia", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 37280,
    name: { en: "Antonia", ro: "Antonia" }, description: { en: "Top national artist. + VAT.", ro: "Artist național de top. + TVA." } }),
  mk({ id: "art_minelli", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 44730, popular: true,
    name: { en: "Minelli", ro: "Minelli" }, description: { en: "Top national artist. + VAT.", ro: "Artist național de top. + TVA." } }),
  mk({ id: "art_the_motans", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 67100,
    name: { en: "The Motans", ro: "The Motans" }, description: { en: "Headliner act. + VAT.", ro: "Cap de afiș. + TVA." } }),
  mk({ id: "art_carlas_dreams", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 67100,
    name: { en: "Carla's Dreams", ro: "Carla's Dreams" }, description: { en: "Headliner act. + VAT.", ro: "Cap de afiș. + TVA." } }),
  mk({ id: "art_inna", category: "artists", eventTypes: [U, H, W], unit: "flat", price: 109340,
    name: { en: "INNA", ro: "INNA" }, description: { en: "International headliner. + VAT.", ro: "Cap de afiș internațional. + TVA." } }),
