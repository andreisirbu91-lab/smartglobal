...
export const CATALOG: CatalogItem[] = [
  ...
  mk({ id: "sga_base", image: "/catalog/sga/packA.jpg", category: "package", eventTypes: [U, H], unit: "per_graduate", price: 125,
  ...
  mk({ id: "sga_expert", image: "/catalog/sga/packB.jpg", category: "package", eventTypes: [U, H], unit: "per_graduate", price: 245, popular: true,
    ...
    includes: { en: ["Robe rental + cap (kept)", "Personalized sash & badge", "Honorary velvet diploma", "Graduation gift box", "Event photography (1 photographer/class)", "Photo session indoor/outdoor", "Orange carpet, photobooth & 360 videobooth", "Livestream + 4K filming + after movie", "Medals & trophies for top students", "Pro sound, LED screens, daylight fireworks", "Host, presidium, event planner & crew"], ro: ["Închiriere robă + tocă (rămâne)", "Eșarfă & insignă personalizate", "Diplomă onorifică pe catifea", "Graduation gift box", "Fotografiere eveniment (1 fotograf/clasă)", "Ședință foto indoor/outdoor", "Orange carpet, photobooth & 360 videobooth", "Livestream + filmare 4K + after movie", "Medalii & trofee pentru șefii de promoție", "Sonorizare pro, ecrane LED, daylight fireworks", "Prezentator, prezidiu, event planner & echipă"] } }),
  mk({ id: "sga_vip", image: "/catalog/sga/packC.jpg", category: "package", eventTypes: [U, H], unit: "per_graduate", price: 320,
    ...
    includes: { en: ["Robe rental + cap (kept)", "Personalized sash & badge", "Honorary velvet diploma", "Graduation gift box", "Event photography (1 photographer/class)", "Photo session indoor/outdoor", "Orange carpet, photobooth & 360 videobooth", "Livestream + 4K filming + after movie", "Medals & trophies for top students", "Pro sound, LED screens, daylight fireworks", "Host, presidium, event planner & crew", "Graduation Village (festival vibes)", "Prosecco van, lemonade & drinks bar", "Smoke entrance moment + remember clip", "Specialty coffee + live DJ mix", "Volumetric letters, roses, premium décor"], ro: ["Închiriere robă + tocă (rămâne)", "Eșarfă & insignă personalizate", "Diplomă onorifică pe catifea", "Graduation gift box", "Fotografiere eveniment (1 fotograf/clasă)", "Ședință foto indoor/outdoor", "Orange carpet, photobooth & 360 videobooth", "Livestream + filmare 4K + after movie", "Medalii & trofee pentru șefii de promoție", "Sonorizare pro, ecrane LED, daylight fireworks", "Prezentator, prezidiu, event planner & echipă", "Graduation Village (festival vibes)", "Prosecco van, lemonade & drinks bar", "Intrare cu fumigene + clip remember", "Specialty coffee + live DJ mix", "Litere volumetrice, trandafiri, decor premium"] } }),
